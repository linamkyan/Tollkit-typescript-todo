...
export function Todo() {
    ...
    const { value: userValue, filter } = useAppSelector(state => state.todo)
    ...
    return (
        <div>
            <div>
                ...
                <button className={styles.only_checks_btn} onClick={handleFilterToDoList} disabled={!userValue.length}>Show only checks </button>
